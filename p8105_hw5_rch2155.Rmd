...
In the following code chunk, a function is created in which there is a tibble with a normal distribution created and a ttest function is included to be applied to the following code that uses the funciton.
